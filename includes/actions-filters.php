...
// ======================================================================== //
    ...
    function bootstrap_shortcodes_styles_all() {
        wp_register_style( 'bootstrap-shortcodes-help-all', plugins_url( 'bs4/includes/help/css/bootstrap-shortcodes-help-all.css' ) );
...
// ======================================================================== //
    ...
    function bootstrap_shortcodes_help_styles() {
        wp_register_style( 'bs-font', plugins_url( 'bs4/includes/help/bs-font.css' ) );
        wp_register_style( 'bootstrap-shortcodes-help', plugins_url( 'bs4/includes/help/css/bootstrap-shortcodes-help.css' ) );
        wp_register_style( 'bootstrap-modal', plugins_url( 'bs4/includes/help/css/bootstrap-modal.css' ) );
        wp_register_script( 'bootstrap', plugins_url( 'bs4/includes/help/js/bootstrap.min.js' ) );
